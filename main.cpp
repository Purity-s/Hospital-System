    ...
    string doctor_Name[], int prices[])
{
    ...
    PrintHospitalBycity("Helsinki", hospitals);
...
int main()
{
    ...
    string patient_Contact[] = {"234534XXX7", "234576XXX2", "857465XXX9",
                                "567657XXX0"};
    int bookingCost[] = {1000, 1200, 1100, 600};

    string hospital_Name[] = {"H1", "H2", "H4", "H3"};
    string locations[] = {"Helsinki", "Helsinki",
                          "Tampere ", "Oulu"};
    int beds[] = {4, 5, 6, 9};
    float ratings[] = {5.2, 4.1, 3.4, 5.9};
    string hospital_Contact[] = {"657534XXX7", "298766XXX2", "324565XXX9",
                                 "343456XXX4"};
